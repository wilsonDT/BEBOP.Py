...
def firstcycle( robot ):
    ...
    print 'Forward..'   
    robot.update( cmd=movePCMDCmd( True, 0, -10, 0, 0 ) )
    ...
    print 'Forward'
    robot.update( cmd=movePCMDCmd( True, 0, -20, 0, 0 ) )
    ...
    print 'Forward'
    robot.update( cmd=movePCMDCmd( True, 0, -30, 0, 0 ) )
    print 'First Cycle Completed!'


def secondcycle( robot ):
    print 'Initiating second cycle'
    print 'Turning left'
    robot.update( cmd=movePCMDCmd( True, 0, 0, -90, 0 ) )
    ...
    print 'Forward..'   
    robot.update( cmd=movePCMDCmd( True, -30, 0, 0 ) )
    ...
    print 'Forward'
    robot.update( cmd=movePCMDCmd( True, 0, -40, 0, 0 ) )
    ...
    print 'Forward..'
    robot.update( cmd=movePCMDCmd( True, 0, -50, 0, 0 ) )
...
def Thirddcycle( robot ):
    ...
    print 'Forward..'   
    robot.update( cmd=movePCMDCmd( True, -60, 0, 0 ) )
    ...
    print 'Forward'
    robot.update( cmd=movePCMDCmd( True, 0, -60, 0, 0 ) )
    ...
    print 'Forward'
    robot.update( cmd=movePCMDCmd( True, 0, -70, 0, 0 ) )
    ...
    print 'Forward'
    robot.update( cmd=movePCMDCmd( True, 0, -80, 0, 0 ) )
    print 'Third Cycle Completed!'


def Surveillance(robot):
    ...
    try:
        ...
        print 'Flat Trimming'
        robot.trim()
        print 'Trim done! Taking off..'
        robot.takeoff()
        robot.wait(5.0)
        print 'Flying higher'
        robot.flyToAltitude(30.0)
        robot.wait(1.0)
        print 'First Cyle starting..'

        robot.firstcycle()
        ##UNANG IKOT OUT OF TATLONG IKOT####
        ...
        robot.resetHome()
        robot.land()
        print'Analyzing data and information from the flight plan...'
